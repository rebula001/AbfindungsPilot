...
如果你拿了 Abfindung 但下家工作还没定（不知道入职日期、月薪也是个谈判区间），很难判断哪个 **“入职时点 × 月薪”** 组合最划算。因为 ALG I（失业救济）、Progressionsvorbehalt (§ 32b EStG, 累进保留)、社保扣款，以及 Fünftelregelung 失效效应同时在起作用。App 把入职日期和月薪档位的笛卡尔积全部算出来，把所有家庭 Netto 画成图表，一眼就能看出从哪个月薪开始早入职值得、从哪开始无所谓。
